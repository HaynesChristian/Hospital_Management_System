        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Canteen Order Delete</span>
            </p>
            <h1 class="mb-3 bread">Canteen Order Delete</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="orderdeletesave.php">
                        ...
                        <td>
                            <div class="form-group">
                              <input type="hidden" name="itemid1" class="form-control" 
                                     readonly=""value="<?php echo $employee_row["Item_Id1"]?>">                                
                              <label for="food" class="text-black">Description1</label>
                              <input type="text" name="food" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Description1"]?>">
                            </div>
                              </td>
                        <td>
                            <div class="form-group">
                              <label for="quantity1" class="text-black">Quantity1</label>
                              <input type="text" name="quantity1" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Quantity1"]?>">
                            </div>
                              </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group">
                              <input type="hidden" name="itemid2" class="form-control" 
                                     readonly="" value="<?php echo $employee_row["Item_Id2"]?>">                                
                              <label for="food2" class="text-black">Description2</label>
                              <input type="text" name="food2" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Description2"]?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                              <label for="quantity2" class="text-black">Quantity2</label>
                              <input type="text" name="quantity2" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Quantity2"]?>">
                            </div>
                              </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group">
                              <input type="hidden" name="itemid3" class="form-control" 
                                     readonly="" value="<?php echo $employee_row["Item_Id3"]?>">                                
                              <label for="food3" class="text-black">Description3</label>
                              <input type="text" name="food3" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Description3"]?>">
                            </div>
                              </td>
                        <td>
                            <div class="form-group">
                              <label for="quantity3" class="text-black">Quantity3</label>
                              <input type="text" name="quantity3" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Quantity3"]?>">
                            </div>
                              </td>
                    </tr>
                    <tr>
                        <td colspan="2">                        
                            ...
                            <input type="text" name="orderamount" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Order_Amount"]?>">
                            </div>                                
                        </td>
                    </tr>
                    </tbody>
