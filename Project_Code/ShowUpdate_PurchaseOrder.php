...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Update Purchase</span></p>
            <h1 class="mb-3 bread">Update Purchase Details</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          <form method="POST" action="update_purchaseOrder.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Update Purchase Details" class="btn btn-primary">
