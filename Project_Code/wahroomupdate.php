...
<table border="1">
    <?php
    $id=$_POST['Update'];
    $dislpaydata = "select * from washroom_cleaning where Washroom_Cleaning_Id=$id";
...
<tr><td></td><td><button formaction="washroomupdatesave.php" name="save" value="<?php echo $row["Washroom_Cleaning_Id"];?>"> Save </button></td><</tr>
</table>
</form>
</table><br>
    <?php
