...
$ReturnQuantityId = $_GET["ReturnQuantityId"];
if($_GET)
{   
...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          <form method="POST" action="update_returnStock.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                $view_supplierdetails = "SELECT * FROM return_stock "
                        . "WHERE return_stock.Return_Quantity_Id = $ReturnQuantityId";
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="ReturnQuantityId" value="<?php echo $ReturnQuantityId;?>">
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Return Date</label>
                            <input type="date" class="form-control"
                              id="returnDate" name="returnDate" value="<?php echo $dr_row["Return_Date"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Return Quantity</label>
                            <input type="number" class="form-control"
                              id="returnQuantity" name="returnQuantity" value="<?php echo $dr_row["Return_Quantity"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
