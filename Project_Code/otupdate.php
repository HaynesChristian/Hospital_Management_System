...
<table border="1">
    <?php
    $id=$_POST['Update'];
    $dislpaydata = "select * from ot_room_cleaning where OT_Room_Cleaning_ID=$id";
...
<tr>
<td>Cleaning_Year</td>
<td><input type="text" name="cyear" value="<?php echo $row["Cleaning_Year"];?>"/></6+*>
</tr>
<tr>
...
<tr><td></td><td><button formaction="otupdatesave.php" name="save" value="<?php echo $row["OT_Room_Cleaning_ID"];?>"> Save </button></td><</tr>
</table>
</form>
</table><br>
    <?php
