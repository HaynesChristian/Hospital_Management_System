    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="roomservicedeletesave.php">
                        ...
                        <td>
                            <div class="form-group">
                              ...
                              <input type="text" name="roomid" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["room_id"]?>">
                            </div>
                        </td>
                        <td>                        
                            <div class="form-group">
                            ...
                            <input type="text" name="roomtype" class="form-control" 
                                   required="" readonly=""
                                     value="<?php echo $employee_row["room_type"]?>">
                            </div>                                
                        </td>
                        <td>                        
                            <div class="form-group">
                            <label for="price" class="text-black">Room Price </label>
                            <input type="text" name="price" class="form-control" 
                           required="" readonly=""
                                     value="<?php echo $employee_row["room_charges"]?>">
                            </div>                                
                        </td>
                        <td>                        
                            <div class="form-group">
                            <label for="status" class="text-black">Room Status </label>
                            <input type="text" name="status" class="form-control" 
                           required="" readonly=""
                                     value="<?php echo $employee_row["room_status"]?>">
                            </div>                                
                        </td>                        
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group">
                                ...
                                <input type="radio" name="fan" value="Available" disabled="" 
                                        <?php if($employee_row["Fan"] == 'Available'){echo "checked='checked'";}?>/> 
                                Available<br>
                                <input type="radio" name="fan" value="UnAvailable" disabled=""
                        ...
                        <td>
                            ...
                            <label for="ac" class="text-black">AC</label><br>
                              <input type="radio" name="ac" value="Available" disabled="" 
                                  <?php if($employee_row["AC"] == 'Available'){echo "checked='checked'";}?>/> 
                              Available<br>
                               <input type="radio" name="ac" value="UnAvailable" disabled="" 
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="radio" name="tv" value="Available" disabled="" 
                                    <?php if($employee_row["TV"] == 'Available'){echo "checked='checked'";}?>/> 
                                Available<br>
                                <input type="radio" name="tv" value="UnAvailable" disabled="" 
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input type="radio" name="refrigerator" value="Available" disabled=""
                                       <?php if($employee_row["Refrigerator"] == 'Available'){echo "checked='checked'";}?>/> 
                                Available<br>
                                <input type="radio" name="refrigerator" value="UnAvailable" disabled=""
