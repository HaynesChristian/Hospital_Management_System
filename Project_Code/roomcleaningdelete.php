...
<table border="1">
    <?php
    $id=$_POST['Delete'];
    $dislpaydata = "select * from room_cleaning where Room_Cleaning_Id=$id";
...
<tr><td></td><td><button formaction="roomcleaningdeletesave.php" name="save" value="<?php echo $row["Room_Cleaning_Id"];?>"> Delete </button></td><</tr>
</table>
</form>
</table><br>
    <?php
