        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <p>
                   ...
                   <h2 align="center"> MATERIAL REPORT </h2>
           
                   <center>
<!--                        <button class="btn btn-primary" data-toggle="modal" data-target="#modalAppointment">Insert Material</button>-->
  ...
  <table class="table table-striped">
    ...
    $dislpaydata = "select * from purchase_order, item_master where item_master.Item_Code = purchase_order.Item_Code";
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
             <form method="post" action="Material_report_1.php">
              <div class="form-group">
                <label for="appointment_id" class="text-black">Material_Id</label>
                <input type="text" class="form-control" id="appointment_id" name="Id">
              </div>
              <div class="form-group">
                <label for="appointment_name" class="text-black">Material_Name</label>
                <input type="text" class="form-control" id="appointment_name" name="Name">
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_pitem" class="text-black">Purchase_Items</label>
                    <input type="text" class="form-control" id="appointment_pitem" name="Purchase">
                  </div>    
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_ritem" class="text-black">Received_Items</label>
                    <input type="text" class="form-control" id="appointment_ritem" name="Received">
                  </div>
                </div>
              </div>
                 <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_items" class="text-black">Return_Defective_Items</label>
                    <input type="text" class="form-control" id="appointment_tems" name="Return_Defective">
                  </div>    
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_did" class="text-black">Material_Distribution_Id</label>
                    <input type="text" class="form-control" id="appointment_did" name="Distribution_Id">
                  </div>
                </div>
              </div>
                 <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_item" class="text-black">Expired_Items</label>
                    <input type="text" class="form-control" id="appointment_item" name="Expired">
                  </div>    
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_date" class="text-black">Material_purchase_Date</label>
                    <input type="text" class="form-control" id="appointment_date" name="Report_Date">
                  </div>
                </div>
              </div>
    ...
    <div class="modal fade" id="modalApp" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form method="post" action="materialreport.php">
            
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_fdate" class="text-black">From</label>
                    <input type="date" name="From_Date" class="form-control" id="appointment_fdate" onchange="checkapt_date()">
                  </div>    
                </div>
                <div class="col-md-6">
                  <div class="form-group">
