      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">New Anaesthesia Consent</h1>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_ac["Surgery_name"]?></td>
                        <td><?php echo $row_patient_ac["Surgeon_name"]?></td>
                        <td><?php echo $row_patient_ac["Doctor_name"]?></td>
                        <?php
                        if($row_patient_ac["Anaesthetist_Name"] == "")
                        {
                        ?>
                        <td>
                            <a href="patient_document_format/Anaesthesia_Consent.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id; ?>"
