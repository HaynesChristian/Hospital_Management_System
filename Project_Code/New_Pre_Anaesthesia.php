      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">New Pre Anaesthesia Evaluation</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient Pre Anaesthesia Evaluation</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <?php 
                $srno = 0;
                $view_patient_pa = "SELECT * FROM treatment_surgery WHERE "
                        . "Treatment_id = $treatment_id";
                $result_patient_pa = mysqli_query($connection, $view_patient_pa);
                if(mysqli_num_rows($result_patient_pa) > 0)
                {
                    while ($row_patient_pa = mysqli_fetch_assoc($result_patient_pa)) 
                    {
                        $srno++;
                ?>
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_pa["Surgery_name"]?></td>
                        <td><?php echo $row_patient_pa["Surgeon_name"]?></td>
                        <td><?php echo $row_patient_pa["Doctor_name"]?></td>
                        <?php
                        if($row_patient_pa["Treatment_id"] == '$treatment_id')
                        {
                        ?>
                        <td>
                            <a href="patient_document_format/Pre_Anaesthesia_Evalution.php?patient_id=<?php echo $patient_id; ?>&treatment_id=<?php echo $treatment_id; ?>&admin_name=<?php echo $login_name;?>&Treatment_Surgery_id=<?php echo $row_patient_pa["Treatment_Surgery_id"]; ?>"
