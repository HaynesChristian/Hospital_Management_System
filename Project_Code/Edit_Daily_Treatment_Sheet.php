      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Daily Treatment Sheet</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient's Daily Treatment Sheet</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Sr No.</th>
                        <th>Daily Treatment date</th>
                        <th>Edit / Print</th>
                    </tr>
                </thead>
                <?php 
                $srno = 0;
                $view_patient_dts = "SELECT * FROM treatment_patient_dailytreatment WHERE "
                ...
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_dts["Daily_Treatment_date"]?></td>
                        <td>
                            <a href="patient_document_update/Daily_Treatment_Sheet.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&admission_time=<?php echo $admission_time?>&admission_date=<?php echo $admission_date?>&treatment_id=<?php echo $treatment_id;?>&Daily_Treatment_id=<?php echo $row_patient_dts["Daily_Treatment_id"]?>"
