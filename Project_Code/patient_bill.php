      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Balance Master</h2>            
          </div>
        </div>
                        ...
                        <td>
                            <table class="table table-striped">
                                ...
                                <th>Income Balance</th>
                                    <?php
                                    $dislpaydata = "select Income_amount from balance_master";
                        ...
                        <td>
                            <table class="table table-striped" align="right">
                                ...
                                <th>Expense Balance</th>
                                    <?php
                                    $dislpaydata = "select Expense_amount from balance_master";
                                    $result = mysqli_query($conn, $dislpaydata);
                                    if(mysqli_num_rows($result)>0)
                                    {
                                        while ($row = mysqli_fetch_assoc($result)) 
                    ...
                    <tr>
                        <td>
                            <table class="table table-striped">
                                ...
                                <th>Asset Balance</th>
                                    <?php
                                    $dislpaydata = "select Asset_amount from balance_master";
                                    $result = mysqli_query($conn, $dislpaydata);
                                    if(mysqli_num_rows($result)>0)
                                    {
                                        while ($row = mysqli_fetch_assoc($result)) 
                        ...
                        <td>
                            <table class="table table-striped">
                                ...
                                <th>Liability Balance</th>
                                    <?php
                                    $dislpaydata = "select Liability_amount from balance_master";
                                    $result = mysqli_query($conn, $dislpaydata);
                                    if(mysqli_num_rows($result)>0)
                                    {
                                        while ($row = mysqli_fetch_assoc($result)) 
