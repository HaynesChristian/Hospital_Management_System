      ...
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form action="Outpatient_Payment_AddUpdate.php" method="POST" onsubmit="return validateForm()">
                ...
                <input type="hidden" value="update_tran" name="update_payment">
            <table class="table table-striped">
                            ...
                            <td>
                                <div class="form-group">
                                  ...
                                  <select class="form-control" required="" id="payment_mode" name="payment_mode">
                                      ...
                                      <option value="Cash" 
                                          <?php if($row_patient["Payment_mode"] == 'Cash'){echo "selected='selected'";}?>> 
                                          Cash</option>
                                      <option value="Other"
                                           <?php if($row_patient["Payment_mode"] == 'Other'){echo "selected='selected'";}?>   >
                                          Other</option>
                                  </select>
                                </div>                                
                            </td>
                            ...
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="doctor_charges" 
                                         required="" name="doctor_charges" min="0" onchange="clear_amount()" oninput="clear_amount()"
                            ...
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="tax_charges" 
                                         required="" name="tax_charges" min="0" onfocus="clear_amount()" oninput="clear_amount()"
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="form-group">
                                  ...
                                  <input type="hidden" class="form-control" id="previous_amt"
                                         name="previous_amt" value="<?php echo $row_patient["Total_charges"]?>">                                   
              ...
              <div class="form-group">
                <input type="submit" value="Update Patient Payment Details" class="btn btn-primary">
              </div>                
            </form>
        </div> 
      </div>
