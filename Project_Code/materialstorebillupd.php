...
<tr><td></td><td><button formaction="materialstorebillupdsave.php" name="save" value="<?php echo $row["Material_bill_store_id"];?>"> Save </button></td></tr>
</table>
</form>
</table><br>
    <?php
