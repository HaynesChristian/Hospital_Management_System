      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Anaesthesia Consent</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient Anaesthesia Consent</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <?php 
                $srno = 0;
                $view_patient_ac = "SELECT * FROM treatment_surgery WHERE "
                        . "Treatment_id = $treatment_id";
                $result_patient_ac = mysqli_query($connection, $view_patient_ac);
                if(mysqli_num_rows($result_patient_ac) > 0)
                {
                    while ($row_patient_ac = mysqli_fetch_assoc($result_patient_ac)) 
                    {
                        $srno++;
                ?>
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_ac["Anaesthetist_Name"]?></td>
                        <td><?php echo $row_patient_ac["Anaesthesia_Type"]?></td>
                        <td>
                            <a href="patient_document_update/Anaesthesia_Consent.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id?>&treatment_surgery_id=<?php echo $row_patient_ac["Treatment_Surgery_id"];?>" 
