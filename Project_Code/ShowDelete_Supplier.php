        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Delete Supplier</span></p>
            <h1 class="mb-3 bread">Delete Supplier Details</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                           ...
                           <textarea name="address"  readonly="" id="address" 
                    ...
                    <tr>
                        <td>
                           <label for="Doctor_qualification" class="text-black">Type</label><br>
                                ...
                                {
                                ?>
                                <input type="radio" readonly=""  id="type" name="type" 
                    ...
                    <tr>
                        <td>
                           <label for="Doctor_speciality" class="text-black">GST No.</label>
                            <input type="text" readonly=""  class="form-control" id="gstno"
                    ...
                    <tr>
                        <td>
                          <label for="Doctor_speciality" class="text-black">Account Number</label>
                            <input type="text" readonly=""  class="form-control" id="accno"
                    ...
                    <tr>
                        <td>
                           <label for="Doctor_speciality" class="text-black">Account Holder Name</label>
                            <input type="text" readonly=""  class="form-control" id="accountHolderName"
                                   name="accountHolderName" value="<?php echo $dr_row["Supplier_AccountHolder_Name"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="submit" value="Delete Supplier Details" class="btn btn-primary">
