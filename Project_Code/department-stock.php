      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Item Master</h1>
          </div>
        </div>
      </div>
    </div>
                  ...
                  <tr style="text-align: center">
                    ...
                    <tr style="text-align: center">
                      <form method="POST" autocomplete="off">
                        ...
                        <td>
                            <a href="ShowUpdate_Stock.php?itemCode=<?php echo $row["Item_Code"];?>&admin_name=<?php echo $login_name;?>"
          ...
          <div class="col-md-2 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                ...
                <li><a href="department-demolition.php?admin_name=<?php echo $login_name;?>">Demolition 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAppointmentLabel">Add Item</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
              <form action="stock.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="form-group">
                  <label for="Doctor_name" class="text-black"> Stock</label><br>
                  <input type="number"  class="form-control" id="availableStock" name="availableStock" required="">
              </div>
                  <div class="form-group">
                ...
                <input type="number" class="form-control" id="rate" name="rate" required="">
                  ...
                  <div class="form-group">
                <label for="Doctor_name" class="text-black">Manufacture Date </label>
                <input type="date" class="form-control" id="manufacturerDate" name="manufacturerDate" required="">
              </div>
                     
                  <div class="form-group">
                <label for="Doctor_name" class="text-black">Expiry Date</label>
                <input type="date" class="form-control" id="expiryDate" name="expiryDate" required="">
              </div>
                  <div class="form-group">
                <label for="Doctor_name" class="text-black">Item Batch Id</label>
                <input type="text" class="form-control" id="itemBatchId" name="itemBatchId" required="">
              </div>
