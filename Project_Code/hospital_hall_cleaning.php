  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalAppointmen">
            <input type="submit" class="btn btn-primary" value="Hospital Hall Cleaning" 
               style="margin-top: 2%">
        </a>
...
<center>
    <table class="table table-striped">
        <h4>Hospital Hall Cleaning</h4>
    <tr>
        <th>Hospital_Cleaning_Id</th>
    ...
    <?php
    $dislpaydata = "select * from hospitalhall_cleaning";
    ...
    <form method="POST" autocomplete="off">
        <td><?php echo $row["Hospital_Cleaning_Id"];?></td>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="hospitalhall.php" autocomplete="off" method="POST">
...
<div class="col-md-6">
              ...
              <div class="col-md-6">      
              <div class="form-group">
                <input type="submit" value="Cleaning Details" class="btn btn-primary" href="hospital_hall_cleaning">
              </div>
                  </div>
            </form>
          </div>
