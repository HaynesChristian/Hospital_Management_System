...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html"><i class="flaticon-pharmacy"></i><span>Tattvam</span> Hospital</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" 
          ...
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Staff</span></p>
            ...
            <div class="row d-flex">
                <div class="col-lg-6 d-flex ftco-animate">
                    <div class="dept d-md-flex">
                        <a href="staff_salary_display.php" class="img" style="background-image: url(images/dept-1.jpg);"></a>
                        <div class="text p-4">
                            <h3><a href="staff_salary_display.php">Employee Basic</a></h3>
                            <p><span class="loc">203 Fake St. California, USA</span></p>
                            <p><span class="doc">22 Doctors</span></p>
                            <p>Far far away, SA</span></p>
                            <p><span class="doc">22 Doctors</span></p>
    			...
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
                                    <a href="createsalary.php" class="img" style="background-image: url(images/dept-2.jpg);"></a>
    					<div class="text p-4">
                                            <h3><a href="createsalary.php">Salary</a></h3>
    						<p><span class="loc">203 Fake St. California, USA</span></p>
    						<p><span class="doc">22 Doctors</span></p>
