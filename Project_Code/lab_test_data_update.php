        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Lab Test Update</span>
            </p>
            <h1 class="mb-3 bread">Lab Test  Update</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="labtestdataupdatesave.php">
              ...
              <table border="0" class="table table-striped" style="width:100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>                        
                            <div class="form-group">
                                <input type="radio" name="teststatus" value="Completed" 
                        ...
                        <td>                        
                            <div class="form-group"> 
                                <input type="radio" name="teststatus" value="Not Completed" 
