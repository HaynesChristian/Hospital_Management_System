...
<html>
    ...
    <body class="container" style="font-family: Times New Roman;" 
        ...
        Visit no. : <?php echo "V".$visit_no?><br><br>
        ...
        <table border="1">
            ...
            <tbody>
                <tr>
                    <td>Consultancy Date</td>
                    <td><?php echo $treatment_date?></td>
                </tr>
                <tr>
                    <td>Consultancy Time</td>
                    <td><?php echo $treatment_time?></td>
                </tr>
                <tr>
                    <td>Doctor Notes</td>
                    <td><?php echo $treatment_details?></td>
                </tr>
                <tr>
                    <td>Next Follow-up Date</td>
                    <td><?php echo $treatment_next_date?></td>
                </tr>
                <tr>
                    <td>Next Follow-up Time</td>
                    <td><?php echo $treatment_next_time?></td>
                </tr>
            </tbody>
        </table>
        <br><br>
