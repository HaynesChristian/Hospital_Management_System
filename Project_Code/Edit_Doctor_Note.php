      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Doctor's Note</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Doctor's Note for Patient</h2>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th>Doctor's note time</th>
                        <th>Edit / Print</th>
                    </tr>
                </thead>
                <?php 
                $srno = 0;
                $view_patient_dnote = "SELECT * FROM treatment_doctor_note WHERE "
                        . "Treatment_id = $treatment_id";
                $result_patient_dnote = mysqli_query($connection, $view_patient_dnote);
                if(mysqli_num_rows($result_patient_dnote) > 0)
                {
                    while ($row_patient_dnote = mysqli_fetch_assoc($result_patient_dnote)) 
                    {
                        $srno++;
                ?>
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_dnote["Doctor_Note_date"]?></td>
                        <td><?php echo $row_patient_dnote["Doctor_Note_time"]?></td>
                        <td>
                            <a href="patient_document_update/Doctor_Note.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id;?>&Doctor_Note_id=<?php echo $row_patient_dnote["Doctor_Note_id"]?>"
