...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php?admin_name=<?php echo $login_name;?>">Home</a></span> <span class="mr-2"><a href="departments.php?admin_name=<?php echo $login_name;?>">Departments</a></span> <span>Purchase Order</span></p>
            <h1 class="mb-3 bread">Purchase Order</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalMedicineRegisteration">
          ...
          <div class="col-md-8 ftco-animate">
              <table border="0" id="myTable" style="padding: 2%" class="table table-striped">
                  ...
                  <tr style="text-align: center">
                    ...
                    <?php
                    $dislpaydata = "select * from purchase_order,item,supplier_master "
                            . "where item.Item_Code = purchase_order.Item_Code And purchase_order.Supplier_Id = supplier_master.Supplier_Id "
                    ...
                    <form method="POST" autocomplete="off">
                        ...
                        <td>
                            <a href="ShowUpdate_PurchaseOrder.php?PurchaseId=<?php echo $row["Purchase_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Update
                            </a><br><br>
                            <a href="Print-PurchaseOrder.php?PurchaseId=<?php echo $row["Purchase_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Print
                              </a>
                         </td>
  ...
  <!-- Purchase Medicine Order Modal -->
    <div class="modal fade" id="modalMedicineRegisteration" tabindex="-1" 
         role="dialog" aria-labelledby="modalAppointmentLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAppointmentLabel">Purchase Order</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
              <form action="purchase.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <select class="form-control" id="supplierName" name="supplierName" required="">
                  ...
                  <div class="form-group">
                <label for="Doctor_name" class="text-black">Item Type</label>
              ...
              <div class="form-group">
                <label for="Doctor_name" class="text-black">Purchase Quantity</label>
                <input type="number" class="form-control" id="purchaseQty" name="purchaseQty" required="">
              </div>
              <div class="form-group">
                  <label for="Doctor_name" class="text-black">Description</label><br>
                 <textarea name="description"
                          id="description" class="form-control" cols="30" rows="10" required=""></textarea>
              </div>
              <div class="form-group">
                <label for="Doctor_name" class="text-black">Unit Price</label>
    ...
    <!-- Purchase Inventory Order Modal -->
    <div class="modal fade" id="modalInventoryRegisteration" tabindex="-1" 
         role="dialog" aria-labelledby="modalAppointmentLabel" aria-hidden="true">
