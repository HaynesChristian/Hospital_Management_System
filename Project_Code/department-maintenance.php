...
<html lang="en">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php?admin_name=<?php echo $login_name;?>">Home</a></span> <span class="mr-2"><a href="departments.php?admin_name=<?php echo $login_name;?>">Departments</a></span> <span>maintenance Of Item</span></p>
            <h1 class="mb-3 bread">Maintenance Of Item</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalMaintenance">
            <input type="submit" class="btn btn-primary" value="Maintenance" 
               style="margin-top: 2%">
        </a>
          ...
          <div class="col-md-8 ftco-animate">
              <table border="0" id="myTable" style="padding: 2%" class="table table-striped">
                  ...
                  <tr style="text-align: center">
                       ...
                       <th>After Depreciation Amount</th>
                       <th>Action</th>
                       
                  </tr>
                    <?php
                    $dislpaydata = "select * from item_master, maintenance_of_item "
                    ...
                    <form method="POST" autocomplete="off">
                        ...
                        <td><?php echo $row["Status_Of_Item"];?></td>
                        <td><?php echo $row["Depreciation_Rate"];?></td>
                        <td><?php echo $row["After_Depreciation_Amount"];?></td>
                        <td>
                            <a href="ShowUpdate_Maintenance.php?MaintenanceId=<?php echo $row["Maintenance_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Update
                            </a>   <br><br>
                            <a href="ShowDelete_Maintenance.php?MaintenanceId=<?php echo $row["Maintenance_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Delete
                              </a>   
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="maintenance.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="form-group">
                <label for="Doctor_name" class="text-black"> Maintenance Date</label>
                <input type="date" class="form-control" id="maintenanceDate" name="maintenanceDate" required="">
              </div>
              <div class="form-group">
                  <label for="Doctor_name" class="text-black">Status Of Item</label><br>
                  <input type="text" class="form-control" id="statusOfItem" name="statusOfItem" required="">
              </div>
              <div class="form-group">
                <label for="Doctor_name" class="text-black">Depreciation Rate</label>
                <input type="text" class="form-control" id="depreciationRate" name="depreciationRate" required="">
              </div>
