...
$DistributionId = $_GET["DistributionId"];
if($_GET)
{   
...
<html lang="en">
  <head>
    <title>Delete Distribution</title>
    <meta charset="utf-8">
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Delete Distribution</span></p>
            <h1 class="mb-3 bread">Delete Distribution Details</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          <form method="POST" action="delete_distribution.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                $view_supplierdetails = "SELECT * FROM distribution_of_item "
                        . "WHERE distribution_of_item.Distribution_Id = $DistributionId";
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" name="DistributionId" value="<?php echo $DistributionId;?>">
                                   <input type="hidden" name="admin_name" value="<?php echo $login_name;?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_contactNo" class="text-black">Distribution Date</label>
                            <input type="date" readonly=""  class="form-control"
                              id="distributionDate" name="distributionDate" value="<?php echo $dr_row["Distribution_Date"];?>">
                         </td
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Distribution Quantity</label>
                            <input type="number"  readonly="" class="form-control"
                             id="distributionQuantity" name="distributionQuantity" value="<?php echo $dr_row["Distribution_Quantity"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Item Receiver</label>
                            <input type="text" readonly=""  class="form-control"
                              id="itemReceiver" name="itemReceiver" value="<?php echo $dr_row["Item_Receiver"];?>">
                        </td>
                    </tr>

                    <tr>
                        <td>
                           <label for="Doctor_qualification" class="text-black">Item Receiver Type</label><br>
                           <input type="text" readonly=""  class="form-control"
                              id="itemReceiverType" name="itemReceiverType" value="<?php echo $dr_row["Item_Receiver_Type"];?>">
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Delete Distribution Details" class="btn btn-primary">
