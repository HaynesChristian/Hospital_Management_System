        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Update Maintenance</span></p>
            <h1 class="mb-3 bread">Update Maintenance Details</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <form method="POST" action="update_maintenance.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Update Maintenance Details" class="btn btn-primary">
