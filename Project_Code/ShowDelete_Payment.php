        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Delete Payment</span></p>
            <h1 class="mb-3 bread">Delete Payment Details</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
          <form method="POST" action="update_payment.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                $view_supplierdetails = "SELECT * FROM payment "
                ...
                <tbody>
                        ...
                        <td>
                             ...
                             <select class="form-control" id="invoiceNo" name="invoiceNo" required="">
                                 ...
                                 <option value="<?php echo $row["Invoice_No"];?>"
                                              <?php if($row["Invoice_No"] == $dr_row["Invoice_No"]){echo "selected='selected'";}?>>
                            ...
                            <select class="form-control" id="supplierId" name="supplierId" required="">
                                    ...
                                    ?>
                                      ...
                                      <option value="<?php echo $row["Supplier_Id"];?>"
                                              <?php if($row["Supplier_Id"] == $dr_row["Supplier_Id"]){echo "selected='selected'";}?>>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="date"  readonly=""  class="form-control"
                              id="purchaseDate" name="paymentDate" value="<?php echo $dr_row["Payment_Date"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Pay Amount</label>
                            <input type="number" readonly="" class="form-control"
                              id="purchaseQty" name="payAmount" value="<?php echo $dr_row["Pay_Amount"];?>">
                        </td>
                    </tr>

                    <tr>
                        <td>
                           <label for="Doctor_qualification" class="text-black">Payment Mode</label><br>
                          
                             <?php 
                                if($dr_row["Payment_Mode"]=="Cash")
                                {
                                ?>
                                <input type="radio" readonly=""  id="paymentMode" name="paymentMode" 
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Delete Payment Details" class="btn btn-primary">
