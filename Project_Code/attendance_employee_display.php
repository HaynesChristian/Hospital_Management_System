            ...
            <div class="row d-flex">
                <div class="col-lg-6 d-flex ftco-animate">
                    <div class="dept d-md-flex">
                        <a href="attendance_employee.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/dailt-attendance.jpg);"></a>
                        <div class="text p-4">
                            <h3><a href="attendance_employee.php?admin_name=<?php echo $login_name;?>">Daily Attendance</a></h3>
                            <p>Daily Attendance shows regular attendance of employees of current month.</p>
                            <ul>
                                <li><span class="ion-ios-checkmark"></span>Regular Attendance</li>
                                <li><span class="ion-ios-checkmark"></span>View Attendance</li>
                            </ul>
                        </div>
                    </div>
                </div>
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
                                    <a href="attendance_balance.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/leave-calculation.jpg);"></a>
    					<div class="text p-4">
                                            <h3><a href="attendance_balance.php?admin_name=<?php echo $login_name;?>">Attendance Calculation</a></h3>
    						<p>Attendance Calculation count present days and leave days of employes.  </p>
    						<ul>
    							<li><span class="ion-ios-checkmark"></span>Calculate Present</li>
    							<li><span class="ion-ios-checkmark"></span>Calculate Absent</li>
    						</ul>
    					</div>
    				</div>
    			</div>
