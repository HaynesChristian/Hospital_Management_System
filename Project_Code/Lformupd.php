...
<tr>
<td>Type of leave</td>
<td><input type="text" name="type" value="<?php echo $row["Type_of_leave"];?>"/></td>
</tr>
<tr>
<td>Leave from</td>
...
<tr><td></td><td><button formaction="Lformupdsave.php" name="save" value="<?php echo $row["Emp_Id"];?>"> Save </button></td></tr>
</table>
</form>
</table><br>
    <?php
