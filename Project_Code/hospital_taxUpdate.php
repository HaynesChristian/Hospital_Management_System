...
<html lang="en">
  <head>
    <title>Update Hospital Tax</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Update Tax Bill Details</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Update Tax Bill</h2>           
          </div>
        </div>
            ...
            <form method="POST" enctype="multipart/form-data">
              <table border="0" class="table table-striped" style="width:100%;">
               ...
               ?>
                    ...
                    <tr>
                       <td>
                           ...
                           <input type="hidden" name="id" value="<?php echo $row["Hospital_tax_id"];?>"/>
                            ...
                            <input type="text" name="name" class="form-control" value="<?php echo $row["Hospital_tax_name"];?>"/>
                       </td>
                        <td>
                            <label for="Hospital_tax_amount" class="text-black">Bill amount</label>
                            <input type="number" class="form-control" name="amt" value="<?php echo $row["Hospital_tax_amount"];?>"/>
                        </td>        
                        </tr>
                     <tr>
                       <td>
                            <label for="hospital_tax_paydate" class="text-black">Bill Pay date</label>
                            <input type="date" class="form-control" name="hpdate" value="<?php echo $row["hospital_tax_bill_paydate"];?>"/>
                       </td>
                       <td>
                ...
                <button formaction="hospitaltaxupdsave.php?admin_name=<?php echo $login_name;?>" 
                        name="save" value="<?php echo $row["Hospital_tax_id"];?>" class="btn btn-primary"> 
                  Update 
               </button>
          </form>
        </div> 
