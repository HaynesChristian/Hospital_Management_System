      ...
      <div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
              <center>
                  <button class="btn btn-primary" data-toggle="modal" 
                          data-target="#modalApp">Generate Material Bill Report</button>
              </center>
              <br>
            <h2 class="mb-4">Material Bill</h2>            
          </div>
        </div>
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <?php
                $dislpaydata = "SELECT invoice.*, purchase_order.Item_Code, item_master.Item_Name "
                        . "FROM invoice,purchase_order,item_master "
                        . "WHERE invoice.Purchase_Id = purchase_order.Purchase_Id "
                        . "AND purchase_order.Item_Code = item_master.Item_Code";
                ...
                ?>
                <tr>
                    <td><?php echo "INV".$row["Invoice_No"];?></td>
  ...
  <!-- Modal -->
    ...
    <div class="modal fade" id="modalApp" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAppointmentLabel">Material Bill</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
              <form method="post" action="material_invoice_display.php">
            
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_date" class="text-black">From</label>
                    <input type="date" name="From_Date" class="form-control" id="appointment_date" onchange="checkapt_date()">
                  </div>    
                </div>
                <div class="col-md-6">
                  <div class="form-group">
