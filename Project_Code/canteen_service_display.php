            ...
            <div class="row d-flex">
                <div class="col-lg-6 d-flex ftco-animate">
                    <div class="dept d-md-flex">
                        <a href="canteen_menu_display.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/dept-1.jpg);"></a>
                        <div class="text p-4">
                            <h3><a href="canteen_menu_display.php?admin_name=<?php echo $login_name;?>">Canteen Menu</a></h3>
    			...
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
                                    <a href="attendance_balance.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/dept-2.jpg);"></a>
    					<div class="text p-4">
                                            <h3><a href="attendance_balance.php?admin_name=<?php echo $login_name;?>">Canteen Order</a></h3>
    						<p><span class="loc">203 Fake St. California, USA</span></p>
    						<p><span class="doc">22 Doctors</span></p>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
    						<ul>
                ...
                <div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
                                    <a href="attendance_balance.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/dept-2.jpg);"></a>
    					<div class="text p-4">
                                            <h3><a href="attendance_balance.php?admin_name=<?php echo $login_name;?>">Canteen Bill</a></h3>
    						<p><span class="loc">203 Fake St. California, USA</span></p>
    						<p><span class="doc">22 Doctors</span></p>
    						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
    						<ul>
