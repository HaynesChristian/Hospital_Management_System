        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Leave Balance Delete</span>
            </p>
            <h1 class="mb-3 bread">Leave Balance Delete</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="Leavedelsave.php?admin_name=<?php echo $login_name;?>">
                <input type="hidden" value="<?php echo $login_name;?>" name="admin_name">      
              <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $act=$_GET['Delete'];
				$displaydata = "select * from leave_master where Employee='$act'";
                        ...
                        <td>
                            <div class="form-group">
                              ...
                              <input type="text" name="Id" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["Employee"]?>">
                            </div>
                              </td>
                    <tr>
                        <td>                        
                            ...
                            <input type="text" name="Year" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["Year"]?>">
                        ...
                        <td>
                            <div class="form-group">
                              ...
                              <input type="text" name="CLB" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["CL_Balance"]?>">
                            </div>
                              </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group">
                              ...
                              <input type="text" name="SLB" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["SL_Balance"]?>">
                            </div>
                              </td>
                    </tr>
                    <tr>
                        <td>
                            <div class="form-group">
                              ...
                              <input type="text" name="PLB" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["PL_Balance"]?>">
                            </div>
                              </td>
                    </tr>
