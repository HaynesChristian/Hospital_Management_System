      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Operative Notes Page(1)</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient Operative Notes Page(1)</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <?php 
                $srno = 0;
                $view_patient_op1 = "SELECT * FROM treatment_surgery WHERE "
                ...
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_op1["Surgeon_name"]?></td>
                        <td><?php echo $row_patient_op1["Asst_Surgeon_Name"]?></td>
                        <td><?php echo $row_patient_op1["Anaesthetist_Name"]?></td>
                        <td>
                            <a href="patient_document_update/Operative_notes(Page1).php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id?>&treatment_surgery_id=<?php echo $row_patient_op1["Treatment_Surgery_id"]; ?>" 
