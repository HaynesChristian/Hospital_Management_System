        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Canteen Bill Update</span>
            </p>
            <h1 class="mb-3 bread">Canteen Bill Update</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Canteen Bill Details</h2>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
            <form method="POST" action="billupdatesave.php">
              ...
              <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $act=$_GET['Update'];
    $displaydata = "select * from patient_canteen_bill where Bill_Id='$act'";
        ...
        while ($employee_row = mysqli_fetch_assoc($result)) 
                ...
                <tbody>
                    <tr>
                        <td>
                            <div class="form-group">
                              <label for="billid" class="text-black">Bill Number</label>
                              <input type="number" name="billid" class="form-control" 
                                     readonly=""
                                     value="<?php echo $employee_row["Bill_Id"]?>">
                            </div>
                              </td>
                    </tr>
                        ...
                        <td>
                            <div class="form-group">
                              ...
                              <input type="date" name="billdate" class="form-control" 
                                     required="" 
                                     value="<?php echo $employee_row["Bill_Date"]?>">
                            </div>
                              </td>
                    </tr>
                    <tr>
                        <td>                        
                            <div class="form-group">
                            <label for="bpatientid" class="text-black">Patient Id</label>
                            <input type="number" name="bpatientid" class="form-control"
                                   readonly=""
                    ...
                    <tr>
                        <td>                        
                            <div class="form-group">
                            <label for="cnt" class="text-black">Total Order</label>
                            <input type="number" name="cnt" class="form-control" 
                                   
                                   value="<?php echo $employee_row["Total_Order"]?>">
                            </div>                                
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>                        
                            <div class="form-group">
                            <label for="bamount" class="text-black">Total Charges</label>
                            <input type="number" name="bamount" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Total_Charges"]?>">
                            </div>                                
                        </td>
                    </tr>
                    </tbody>
