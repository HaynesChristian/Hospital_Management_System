...
$DemolitionItemId = $_GET["DemolitionItemId"];
if($_GET)
{   
  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Delete Demolition</span></p>
            <h1 class="mb-3 bread">Delete Demolition Details</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          <form method="POST" action="delete_demolition.php">
              <table border="1" class="table table-striped" style="width:75%;">
                <thead>
                    <tr>
                        <th>Demolition Details</th>
                ...
                $view_supplierdetails = "SELECT * FROM demolition_item "
                        . "WHERE demolition_item.Demolition_Item_Id = $DemolitionItemId";
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                             ...
                             <select class="form-control" id="itemCode" name="itemCode" required="">
                                    ...
                                    ?>
                                        <option value="<?php echo $row["Item_Code"];?>"
                                              <?php if($row["Item_Code"] == $dr_row["Item_Code"]){echo "selected='selected'";}?>>
                            ...
                            <input type="hidden" name="DemolitionItemId" value="<?php echo $DemolitionItemId;?>">
                                  <input type="hidden" name="admin_name" value="<?php echo $login_name;?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="QuantityOfDemolition" class="text-black">Quantity Of Demolition</label>
                            <input type="number" readonly="" class="form-control" id="QuantityOfDemolition" name="QuantityOfDemolition" value="<?php echo $dr_row["Quantity_Of_Demolition"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Unit Price</label>
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Date of Demolition</label>
                            <input type="date" readonly=""  class="form-control"
                              id="DateOfDemolition" name="DateOfDemolition" value="<?php echo $dr_row["Date_Of_Demolition"];?>">
                        </td>
                    </tr>

                    <tr>
                        <td>
                           <label for="Doctor_qualification" class="text-black">Reason Of Demolition</label><br>
                           <input type="text"  readonly="" class="form-control"
                              id="ReasonOfDemolition" name="ReasonOfDemolition" value="<?php echo $dr_row["Reason_Of_Demolition"];?>">
                            
                        </td>
                    </tr>
                     <tr>
                        <td>
                           <label for="Doctor_qualification" class="text-black">Description</label><br>
                           <input type="text"  readonly="" class="form-control"
                              id="Description" name="Description" value="<?php echo $dr_row["Description"];?>">
                            
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="submit" value="Delete Demolition Details" class="btn btn-primary">
