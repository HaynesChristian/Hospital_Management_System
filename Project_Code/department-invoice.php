...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php?admin_name=<?php echo $login_name;?>">Home</a></span> <span class="mr-2"><a href="departments.php?admin_name=<?php echo $login_name;?>">Departments</a></span> <span>Invoice</span></p>
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalInvoice">
          ...
          <div class="col-md-8 ftco-animate">
              <table border="0" id="myTable" style="padding: 2%" class="table table-striped">
                  ...
                  <tr style="text-align: center">
                   ...
                   <?php
                    $dislpaydata = "select * from invoice,purchase_order,item_master,supplier_master "
                            . "where invoice.Purchase_Id = purchase_order.Purchase_Id And "
                            . "item_master.Item_Code = purchase_order.Item_Code And "
                            . "supplier_master.Supplier_Id = purchase_order.Supplier_Id "
                    ...
                    <form method="POST" autocomplete="off">
                        ...
                        <td>
                         ...
                         <a href="ShowUpdate_Invoice.php?InvoiceNo=<?php echo $row["Invoice_No"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Update
                         </a>   <br><br>
                                        <a href="ShowDelete_Invoice.php?InvoiceNo=<?php echo $row["Invoice_No"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Delete
                              </a>    
                         </td>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAppointmentLabel">Invoice</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
              <form action="invoice.php" method="POST" enctype="multipart/form-data" autocomplete="off">
   ...
   <div class="modal fade" id="modalDocView" 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">    
              <?php
                    $dislpaydata = "select * from invoice where Invoice_No = $invoiceNo";
                    $result = mysqli_query($connection, $dislpaydata);
                    if(mysqli_num_rows($result) > 0)
                    {
              ...
              <div class="form-group">
                <label for="Doctor_contactNo" class="text-black">Quantity</label>
                <input type="number" class="form-control"
                       id="Qty" name="Qty" value="<?php echo $dr_row["Quantity"];?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" value="Update Invoice Details" class="btn btn-primary">
              </div>                  
            </form>
            <?php
                }
