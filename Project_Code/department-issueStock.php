...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Issue Stock</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalIssueStock">
            <input type="submit" class="btn btn-primary" value="Issue Stock" 
               style="margin-top: 2%">
        </a>
    </center>
          ...
          <div class="col-md-8 ftco-animate">
              <table border="0" style="padding: 2%" id="myTable" class="table table-striped">
                  ...
                  <tr style="text-align: center">
                    ...
                    <?php
                    $dislpaydata = "select * from item_master ,issue_stock "
                            . "where item_master.Item_Code = issue_stock.Item_Code "
                            . "ORDER BY Issue_Quantity_Id DESC";
                    ...
                    <tr style="text-align: center">
                      <form method="POST" autocomplete="off">
                        ...
                        <td>
                            <a href="ShowUpdate_IssueStock.php?IssueQuantityId=<?php echo $row["Issue_Quantity_Id"];?>&admin_name=<?php echo $login_name;?>"
  ...
  <!-- Issue Stock Modal -->
    <div class="modal fade" id="modalIssueStock" tabindex="-1" 
         role="dialog" aria-labelledby="modalAppointmentLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalAppointmentLabel">Issue Stock</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
              <form action="Issue-stock.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="form-group">
                  <label for="Doctor_name" class="text-black"> Issue Quantity</label><br>
                  <input type="number"  class="form-control" id="issueQty" name="issueQty" required="">
              </div>
                  <div class="form-group">
