    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="labsampleupdatesave.php">
                <input type="hidden" value="<?php echo $login_name;?>" name="admin_name"> 
                <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $act=$_GET['Update'];
                $displaydata = "select * from lab_master where Test_Id=$act";
                ...
                if(mysqli_num_rows($result)>0)
                {
                    ...
                    {
                ?>
                <input type="hidden" value="<?php echo $act;?>" name="Test_id">    
                <tbody>
                    <tr>
                        <td>
                            <div class="form-group">
                              ...
                              <input type="text" name="test_type" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["Test_Type"]?>">
                            </div>
                        </td>
                        <td>                        
                            <div class="form-group">
                           ...
                           <input type="text" name="description" class="form-control" 
                                  readonly="" value="<?php echo $employee_row["Test_Description"]?>">
                            </div>                                
                        </td>
                        <td>                        
                            <div class="form-group">
                            <label for="testcharges" class="text-black">Test Charges </label>
                            <input type="number" name="testcharges" class="form-control" 
                                     required="" min="20"
