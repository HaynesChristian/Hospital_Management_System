...
<table border="1">
    ...
    <?php
    $id=$_POST['Delete'];
    $dislpaydata = "select * from canteen_cleaning where Canteen_Cleaning_Id=$id";
...
<tr><td></td><td><button formaction="canteendeletesave.php" name="save" value="<?php echo $row["Canteen_Cleaning_Id"];?>"> Delete </button></td></tr>
</table>
</form>
</table><br>
    <?php
