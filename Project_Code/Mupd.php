...
<td><input type="date" name="mdate" value="<?php echo $row["manufacture_Date"];?>"/></td>
</tr>
<tr>
<td>Expiry_Date</td>
...
<tr><td></td><td><button formaction="Mupdsave.php" name="save" value="<?php echo $row["Medicine_Id"];?>"> Save </button></td></tr>
</table>
</form>
</table><br>
    <?php
