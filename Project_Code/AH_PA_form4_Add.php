...
if($_POST)
{
    ...
    $Provision_Diagnosis = $_POST["Provision_Diagnosis"];
    $Suggested_Investigation = $_POST["Suggested_Investigation"];
    $CarePlan = $_POST["CarePlan"];
    $Preventive_Diet = $_POST["Preventive_Diet"];
    $Preventive_Drugs = $_POST["Preventive_Drugs"];
    ...
    else
    {
        ...
        . "window.location.href = 'Inpatient_Treatment.php?patient_id=$patient_id&admin_name=$login_name';"
        . "</script>";        
    }
