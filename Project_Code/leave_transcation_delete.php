    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="Lformdelsave.php">
                
              <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $id=$_GET['Delete'];
				$displaydata = "select employee_master.Employee_Name , leave_form.* from leave_form,employee_master WHERE leave_form.Emp_Id = employee_master.Employee_Id AND Leave_id='$id'";
                    ...
                    <tr>
                        <td>                        
                            ...
                            <input type="text" name="type" class="form-control" readonly=""
                                    value="<?php echo $employee_row["Type_of_leave"]?>">
                            </div>                                
                        </td>
                        <td>                        
                            <div class="form-group">
                            <label for="lfrom" class="text-black">Leave From</label>
                            <input type="date" name="lfrom" class="form-control" readonly="" 
                        ...
                        <td>                        
                            ...
                            <input type="date" name="lto" class="form-control"  readonly=""
                        ...
                        <td>                        
                            ...
                            <input type="text" name="total" class="form-control" readonly="" value="<?php echo $employee_row["Total"]?>">
                            </div>                                
                        </td>
                    </tr>
                    </tbody>
