      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php?admin_name=<?php echo $login_name;?>">Home</a></span> <span class="mr-2"><a href="departments.php?admin_name=<?php echo $login_name;?>">Departments</a></span> <span>Supplier</span></p>
                  ...
                  <tr style="text-align: center">
                    ...
                    <tr style="text-align: center">
                      <form method="POST" autocomplete="off">
                        ...
                        <td><?php echo $dr_row["Supplier_Name"];?></td>
                        <td><?php echo $dr_row["Supplier_Email"];?></td>
                        <td><?php echo $dr_row["Supplier_MobileNo"];?></td>
                        <td><?php echo $dr_row["Supplier_Address"];?></td>
                        <td><?php echo $dr_row["Supplier_Type"];?></td>
                       
                        <td>
                            <a href="ShowUpdate_Supplier.php?SupplierId=<?php echo $dr_row["Supplier_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Update
                            </a>  <br><br>
                            <a href="ShowDelete_Supplier.php?SupplierId=<?php echo $dr_row["Supplier_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Delete
                              </a>             
                         </td>
