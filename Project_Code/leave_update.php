        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Leave Balance Update</span>
            </p>
            <h1 class="mb-3 bread">Leave Balance Update</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Leave Balance Details</h2>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
            <form method="POST" action="Leaveupdsave.php?admin_name=<?php echo $login_name;?>">
                <input type="hidden" value="<?php echo $login_name;?>" name="admin_name">      
              <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $act=$_GET['Update'];
				$displaydata = "select employee_master.Employee_Name , leave_master.* from leave_master,employee_master WHERE leave_master.Employee = employee_master.Employee_Id AND Employee='$act'";
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <label for="Id" class="text-black">Employee Name</label>
                            <input type="text" name="emp_name" class="form-control" 
									required="" readonly="" value="<?php echo $employee_row["Employee_Name"]?>">
							<input type="hidden" value="<?php echo $employee_row["Employee"];?>" name="Id">	 
                            </div>
                        </td>
                        <td>                        
                            <div class="form-group">
                            ...
                            <input type="text" name="Year" class="form-control" 
                                     required="" readonly="" value="<?php echo $employee_row["Year"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                              <label for="CLB" class="text-black">CL Balance</label>
                              <input type="text" name="CLB" class="form-control" 
                                     required="" value="<?php echo $employee_row["CL_Balance"]?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                              <label for="SLB" class="text-black">SL Balance</label>
                              <input type="text" name="SLB" class="form-control" 
                                     required="" value="<?php echo $employee_row["SL_Balance"]?>">
                            </div>
                        </td>
                        <td>
                            <div class="form-group">
                              <label for="PLB" class="text-black">PL Balance</label>
                              <input type="text" name="PLB" class="form-control" 
                                     required="" value="<?php echo $employee_row["PL_Balance"]?>">
                            </div>
                        </td>
                    </tr>    
                </tbody>
