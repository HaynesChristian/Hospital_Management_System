...
$view_patient = "SELECT Patient_Name,Patient_Bill_id FROM patient,patient_bill WHERE "
        . "patient.Patient_id = $patient_id AND patient_bill.Patient_id = $patient_id "
        . "AND patient_bill.Treatment_id = $treatment_id";
...
if(mysqli_num_rows($result_pat) > 0)
{
    while ($row_patient = mysqli_fetch_assoc($result_pat)) 
    {
        ...
        $patient_bill_id = $row_patient["Patient_Bill_id"];
    }
}
...
<html lang="en">
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form action="Inpatient_Payment_Update.php" method="POST" onsubmit="return validateForm()">
                ...
                <input type="hidden" value="<?php echo $patient_bill_id?>" name="patient_bill_id">
            <table class="table table-striped">
                    <?php 
                    $view_patient = "SELECT * FROM patient_bill WHERE Patient_Bill_id = $patient_bill_id";
                            ...
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="payment_date" 
                                         ...
                                         value="<?php echo $row_patient["Patient_Bill_date"];?>">
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="time" class="form-control" id="payment_time" 
                                         required="" name="payment_time" 
                                         value="<?php echo $row_patient["Patient_Bill_time"];?>">
                                </div>                                
                            </td>                            
                            <td>
                                <div class="form-group">
                                  ...
                                  <select class="form-control" required="" id="payment_mode" name="payment_mode">
                                      <option value="Cash" 
                                          <?php if($row_patient["Patient_Payment_mode"] == 'Cash'){echo "selected='selected'";}?>>
                                          Cash</option>
                                      <option value="Other"
                                          <?php if($row_patient["Patient_Payment_mode"] == 'Other'){echo "selected='selected'";}?>> 
                                          Other</option>
                                  </select>
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="radio" name="payment_status" required="" 
                                         id="payment_status" value="paid" 
                                         <?php if($row_patient["Patient_Payment_status"] == 'paid'){echo "checked='checked'";}?>/> 
                                  Paid<br>
                                  <input type="radio" name="payment_status" required="" 
                                         id="payment_status" value="unpaid"
                                         <?php if($row_patient["Patient_Payment_status"] == 'unpaid'){echo "checked='checked'";}?>/> 
                                  Unpaid
                                </div>                                
                            </td>                            
                        </tr>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" id="doctor_name" required="" name="doctor_name">
                                    ...
                                    <option value="<?php echo $dr_row["Doctor_Name"];?>"
                                            <?php if($row_patient["Doctor_name"] == $dr_row["Doctor_Name"]){echo "selected='selected'";}?>>
                            ...
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="doctor_charges" min="0"
                                         required="" name="doctor_charges" value="<?php echo $row_patient["Doctor_Charges"];?>">                                  
                                </div>                                
                            </td>                            
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="nursing_charges" min="0"
                                         readonly="" name="nursing_charges" value="<?php echo $row_patient["Nursing_charges"];?>">                                  
                                </div>                                
                            </td>                            
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="tax_charges" min="0"
                                         required="" name="tax_charges" value="<?php echo $row_patient["Tax_Charges"];?>">
                                </div>                                
                            </td>                            
                        </tr>                        
                        <tr>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="canteen_charges" min="0"
                                         readonly="" name="canteen_charges" value="<?php echo $row_patient["Canteen_charges"];?>">                                  
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  <label for="room_charges" class="text-black">Room Charges</label>
                                  <input type="number" class="form-control" id="room_charges" min="0" 
                                         readonly="" name="room_charges" value="<?php echo $row_patient["Room_Charges"];?>">
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="lab_charges" min="0" 
                                         readonly="" name="lab_charges" value="<?php echo $row_patient["Laboratary_charges"];?>">
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="xray_charges" min="0" 
                                         readonly="" name="xray_charges" value="<?php echo $row_patient["Xray_charges"];?>">                                  
                                </div>                                
                            </td>                            
                        </tr>                        
                        <tr>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="ot_charges" min="0" 
                                         required="" name="ot_charges" value="<?php echo $row_patient["OT_charges"];?>">                                  
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="anaethetist_charges" min="0" 
                                         required="" name="anaethetist_charges" value="<?php echo $row_patient["Anaesthesia_charges"];?>">
                                </div>                                
                            </td> 
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="biowaste_charges" min="0" 
                                         required="" name="biowaste_charges" value="<?php echo $row_patient["Biowaste_charges"];?>">                                  
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control" id="medicine_charges" min="0" 
                                         required="" name="medicine_charges" value="<?php echo $row_patient["Medicine_charges"];?>">
                                </div>                                
                            </td>                            
                        </tr>
                        <tr>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="radio" name="mediclaim_exist" required="" 
                                         id="mediclaim_exist" value="yes"
                                         <?php if($row_patient["Mediclaim_existense"] == 'yes'){echo "checked='checked'";}?>/>
                                  Yes<br>
                                  <input type="radio" name="mediclaim_exist" required="" 
                                         id="mediclaim_exist" value="no"
                                         <?php if($row_patient["Mediclaim_existense"] == 'no'){echo "checked='checked'";}?>/>
                                  No
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="date" class="form-control" id="discharge_date" onchange="checkdischarge_date()"
                                         readonly="" name="discharge_date" value="<?php echo $row_patient["Discharge_date"];?>">
                                </div>                                
                            </td>
                            <td>
                                <div class="form-group">
                                  ...
                                  <input type="time" class="form-control" id="discharge_time" 
                                         required="" name="discharge_time" value="<?php echo $row_patient["Discharge_time"];?>">
                            </td>                            
                            <td>
                                <div class="form-group">
              ...
              <div class="form-group">
                <input type="submit" value="Update Patient Payment" class="btn btn-primary">
                <button class="btn btn-primary" 
                        formaction="Print_Inpatient_PaymentReceipt.php?patient_id=<?php echo $patient_id; ?>&treatment_id=<?php echo $treatment_id; ?>&admin_name=<?php echo $login_name?>&Patient_Admission_id=<?php echo $Patient_Admission_id; ?>&patient_bill_id=<?php echo $patient_bill_id?>">Print</button>
              </div>                
            </form>
        </div>
      </div>
  ...
  <script>
      ...
      function calculate_amount()
      {
          ...
          var total = parseInt(dc) + parseInt(tc) + parseInt(nc) + parseInt(cc) + parseInt(rc) 
                  + parseInt(otc) + parseInt(ac) + parseInt(bc) + parseInt(mc) + parseInt(lc) + parseInt(xc);
