...
<html lang="en">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2">
                ...
                <span class="mr-2"><a href="doctor.php?admin_name=<?php echo $login_name;?>">Doctor</a></span> <span>Appointments</span></p>
            <h2 class="mb-3 bread">Appointments</h2>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                  ...
                  <div class="col-md-4">
                      <form action="#" class="search-form">
                          <div class="form-group">
                              <span class="icon fa fa-search"></span>
                              <input type="text" placeholder="Filter By Visitor Name" class="form-control" 
                                   id="searchpatientname" onkeyup="Allpatientname()">
                          </div>
                      </form>
                  </div>                  
              </div>
              <table border="0" class="table table-striped"  id="AllappointmentTable">
                  <thead>
                        <tr>
                            <th>Doctor Name</th>
                            <th>Visiting Date</th>
                    ...
                    //echo "$current_date";
                    $apt = "SELECT * FROM doctor_appointment_list ORDER BY Doctor_Appointment_date DESC";
                    ...
                    <form method="POST">                        
                        <tr>
                            <input type="hidden" name="appointment_id" value="<?php echo $apt_row["Doctor_Appointment_id"];?>">
                            <td><?php echo $apt_row["Doctor_name"];?></td>
                            <td style="display:none"><?php echo $apt_row["Doctor_Appointment_date"];?></td>
                            ...
                            <td><?php echo $apt_row["Visitor_Email"];?></td>
                            <td><?php echo $apt_row["Appointment_Description"];?></td>
                            <td><?php echo $apt_row["Doctor_Appointment_status"];?></td>
                            <td>
                                <button <?php if($apt_row["Doctor_Appointment_status"] == 'completed')
                                    {echo "style='display:none'";}?>
                                    formaction="Appointment_ShowUpdate.php?admin_name=<?php echo $login_name;?>" class="btn btn-primary">
                                    Update
                                </button>
                            </td>
                        </tr>
  ...
  <script>
        function Alldoctorname() 
        {
          ...
          table = document.getElementById("AllappointmentTable");
