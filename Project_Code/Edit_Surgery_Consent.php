      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Surgery Consent</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient Surgery Consent</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <?php 
                $srno = 0;
                $view_patient_sc = "SELECT * FROM treatment_surgery WHERE "
                        . "Treatment_id = $treatment_id";
                $result_patient_sc = mysqli_query($connection, $view_patient_sc);
                if(mysqli_num_rows($result_patient_sc) > 0)
                {
                    while ($row_patient_sc = mysqli_fetch_assoc($result_patient_sc)) 
                    {
                        $srno++;
                ?>
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_sc["Surgery_name"]?></td>
                        <td><?php echo $row_patient_sc["Surgeon_name"]?></td>
                        <td><?php echo $row_patient_sc["Doctor_name"]?></td>
                        <td>
                            <a href="patient_document_update/Surgery_Consent.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id?>&treatment_surgery_id=<?php echo $row_patient_sc["Treatment_Surgery_id"]; ?>" 
