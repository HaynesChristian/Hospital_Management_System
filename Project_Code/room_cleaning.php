  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalAppointmen">
            <input type="submit" class="btn btn-primary" value="Room Cleaning" 
               style="margin-top: 2%">
        </a>
      ...
      <div class="modal-dialog " role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="roomcleaning.php" autocomplete="off" method="POST">
              ...
              <div class="col-md-6">      
              <div class="form-group">
                <input type="submit" value="Cleaning Details" class="btn btn-primary" href="room_cleaning">
              </div>
                  </div>
            </form>
          </div>
