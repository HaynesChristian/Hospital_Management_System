...
<html lang="en">
        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <p>
                   ...
                   <h2 align="center"> INCOME EXPENSE REPORT </h2>
           
                   <center>
                       <a class="btn btn-primary" data-toggle="modal" data-target="#modalApp" style="margin-top: 2%" >
                           Generate Date
                       </a>
                   </center>
                   <br>
  ...
  <?php
    ...
    ?>
                ...
                <center>
                    <a href="materialfrom_to_date.php">
            <input type="submit" class="btn btn-primary" value="Generate Report" 
              ...
              <h2 align="center">BIOWASTE DISPACH REPORT </h2>
           
                <center>
                    <a href="biowastefrom_to_date.php">
            <input type="submit" class="btn btn-primary" value="Generate Report" 
               style="margin-top: 2%">
        </a>
                    
                     <h2 align="center">MEDICINE EXPIRY REPORT </h2>
           
                <center>
                    <a href="Mfrom_to_date.php">
            <input type="submit" class="btn btn-primary" value="Generate Report" 
               style="margin-top: 2%">
        </a>
                    <br><br>
          ...
          <div class="col-md-4 sidebar ftco-animate">
            ...
            <div class="sidebar-box ftco-animate">
              <div class="categories">
                <h3>Categories</h3>
                <li><a href="#">Staff reports <span>(12)</span></a></li>
                <li><a href="#">Income Expense report <span>(22)</span></a></li>
                <li><a href="#">Material report <span>(37)</span></a></li>
                <li><a href="#">Bio-Waste report <span>(42)</span></a></li>
                <li><a href="#">Inspection report <span>(14)</span></a></li>
                <li><a href="#">Medicine Expiry report <span>(140)</span></a></li>
                <li><a href="#">General report <span>(15)</span></a></li>
              </div>
            </div>
    ...
    <div class="modal fade" id="modalApp" tabindex="-1" role="dialog" aria-labelledby="modalAppointmentLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
             <form method="post" action="income_expensedisplay.php">
