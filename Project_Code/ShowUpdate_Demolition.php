  ...
  <body>
   ...
   <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Update Demolition</span></p>
            <h1 class="mb-3 bread">Update Demolition Details</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          <form method="POST" action="update_demolition.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_contactNo" class="text-black">Quantity Of Demolition</label>
                            <input type="number" class="form-control"
                              id="QuantityOfDemolition" name="QuantityOfDemolition" value="<?php echo $dr_row["Quantity_Of_Demolition"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Update Demolition Details" class="btn btn-primary">
