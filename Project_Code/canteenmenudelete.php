...
<table border="1">
    <tr>
<td>Food_Item_Id</td>
<td><input type="text" name="item" value="<?php echo $row["Food_Item_Id"];?>"/></td>
</tr>
<tr>
...
<tr><td><button formaction="canteenmenudeletesave.php" name="save" value="<?php echo $row["Menu_Sr_No"];?>"> Delete </button></td></tr>
</table>
</form>
</table><br>
    <?php
