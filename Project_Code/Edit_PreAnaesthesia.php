      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Pre Anaesthesia</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient Pre Anaesthesia</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_pa["Pre_operative_diagnosis"]?></td>
                        <td><?php echo $row_patient_pa["Procedure_planned"]?></td>
                        <td><?php echo $row_patient_pa["Doctor_name"]?></td>
                        <td>
                            <a href="patient_document_update/Pre_Anaesthesia_Evalution.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id?>&treatment_surgery_id=<?php echo $row_patient_pa["Treatment_Surgery_id"]; ?>" 
