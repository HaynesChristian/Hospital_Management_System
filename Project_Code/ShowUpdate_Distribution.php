        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Update Distribution</span></p>
            <h1 class="mb-3 bread">Update Distribution Details</h1>
          </div>
        </div>
      </div>
    </div>
          ...
          <form method="POST" action="update_distribution.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Update Distribution Details" class="btn btn-primary">
