        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Lab Test Delete</span>
            </p>
            <h1 class="mb-3 bread">Lab Test  Delete</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="labtestdatadeletesave.php">
               ...
               <input type="hidden" value="<?php echo $act;?>" name="patient_test_id">               
              <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $displaydata = "select * from lab_test_data where Patient_Test_Id=$act";
                        ...
                        <td>
                            <div class="form-group">
                              ...
                              <input type="date" name="testdate" class="form-control" 
                                     readonly="" value="<?php echo $employee_row["Test_Date"]?>">
                            </div>
                        </td>
                        <td>                        
                            <div class="form-group">
                            <label for="testdescription" class="text-black">Test Description </label>
                            <input type="text" name="testdescription" class="form-control" 
                                   required="" readonly=""
                                     value="<?php echo $employee_row["Test_Description"]?>">
                            </div>                                
                        </td>
                        <td>                        
                            <div class="form-group">
                            <label for="testcharegs" class="text-black">Test Charges </label>
                            <input type="number" name="testcharegs" class="form-control" 
                                   required="" readonly=""
                                     value="<?php echo $employee_row["Test_Charges"]?>">
                            </div>                                
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>                        
                            <div class="form-group">
                                <input type="radio" name="teststatus" value="Completed" disabled=""
                                       <?php if($employee_row["Test_Status"] == 'Completed')
                                           {echo "checked='checked'";}?>/> Completed
                            </div>                                
                        </td>
                        <td>                        
                            <div class="form-group"> 
                                <input type="radio" name="teststatus" value="Not Completed" disabled=""
                                       <?php if($employee_row["Test_Status"] == 'Not Completed')
                                           {echo "checked='checked'";}?>/> Not Completed
                            </div>                                
                        </td>                        
                    </tr>
                    </tbody>
