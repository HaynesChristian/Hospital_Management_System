        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
               ...
               <span class="mr-2"><a href="medical_expiry_report.php?admin_name=$login_name">Medicine Expiry report details</a></span></p>
<!--                <span class="mr-2"><a href="biowaste_report.php">Medicine Expiry report details</a></span> -->
            <h1 class="mb-3 bread">Delete Medicine expiry Details</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Delete Medicine expiry</h2>           
          </div>
        </div>
        <div class="row d-flex justify-content-center">
            <form method="POST" enctype="multipart/form-data">
                    ...
                    <tr>
                       <td>
                           ...
                           <input type="text" class="form-control" id="medicine_name" 
                                  name="medicine_name" readonly="" value="<?php echo $row["Medicine_Name"];?>"/>
                       </td>
                       <td>
                           <label for="mdate" class="text-black">Manufacture Date</label>
                           <input type="date"  class="form-control" id="mdate" 
                                  name="mdate" readonly="" value="<?php echo $row["manufacture_Date"];?>"/>
                       </td>
                       <td>
                           <label for="edate" class="text-black">Expiry Date</label>
                           <input type="date"  class="form-control" id="edate" 
                                  name="edate" readonly="" value="<?php echo $row["Expiry_Date"];?>"/>
                       </td> 
                    </tr>
                    <tr>
                        <td>
              ...
              <button formaction="Mdelsave.php" name="save" value="<?php echo $row["Medicine_Id"];?>" class="btn btn-primary"> 
                  Delete 
               </button>
          </form>
        </div> 
