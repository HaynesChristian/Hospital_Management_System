    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
                ...
                <tbody>
                    <tr>
                       <td>
                           ...
                           <input type="number" class="form-control" name="amt" value="<?php echo $row["Electricity_bill_amount"];?>"/>
                       </td>
                       <td>
            ...
            <button formaction="electricityupdsave.php?admin_name=<?php echo $login_name;?>" 
                    name="save" value="<?php echo $row["Electricity_bill_id"];?>" 
