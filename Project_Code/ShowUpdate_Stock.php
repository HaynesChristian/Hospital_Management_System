        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Update Stock</span></p>
            <h1 class="mb-3 bread">Update Stock Details</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
          <form method="POST" action="update_stock.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                $view_supplierdetails = "SELECT * FROM item_master "
                        . "WHERE item_master.Item_Code = $itemCode";
                ...
                if(mysqli_num_rows($result_doctorlist) > 0)
               {
                ...
                <tbody>
                             ...
                             <select class="form-control" id="itemName" name="itemName" required="">
                                    ...
                                    ?>
                                      ...
                                      <option value="<?php echo $row["Item_Name"];?>"
                                              <?php if($row["Item_Name"] == $dr_row["Item_Name"]){echo "selected='selected'";}?>>
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Stock</label>
                            <input type="number" class="form-control"
                              id="stock" name="stock" value="<?php echo $dr_row["Available_Stock"];?>">
                        </td>
                    </tr>
                        ...
                        <td>
                           <label for="Doctor_qualification" class="text-black">Unit Of Measure</label><br>
                             ...
                             <?php 
                                ...
                                {
                                ?>
                                <input type="radio" id="uom" name="uom" 
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Manufacture Date</label>
                            <input type="date" class="form-control"
                              id="manufactureDate" name="manufactureDate" value="<?php echo $dr_row["Manufacture_Date"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Expiry Date</label>
                            <input type="date" class="form-control"
                              id="expiryDate" name="expiryDate" value="<?php echo $dr_row["Expiry_Date"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Item Batch Id</label>
                            <input type="text" class="form-control"
                              id="itemBatchId" name="itemBatchId" value="<?php echo $dr_row["Item_Batch_Id"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="submit" value="Update Stock Details" class="btn btn-primary">
