            ...
            <div class="row d-flex">
                <div class="col-lg-6 d-flex ftco-animate">
                    <div class="dept d-md-flex">
                        <a href="leave_balance.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/leave-balance.png);"></a>
                        <div class="text p-4">
                            <h3><a href="leave_balance.php?admin_name=<?php echo $login_name;?>">Leave Balance</a></h3>
                            <p>Leave Balance mantain details of Employees leave balance. </p>
                            <ul>
                                <li><span class="ion-ios-checkmark"></span>Calculate Leave Balance</li>
                            </ul>
                        </div>
                    </div>
                </div>
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
                                    <a href="leave_transaction.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/leave-transcation.png);"></a>
    					<div class="text p-4">
                                            <h3><a href="leave_transaction.php?admin_name=<?php echo $login_name;?>">Leave Transaction</a></h3>
    						<p>Leave Transcation store leaves of employees. </p>
    						<ul>
    							<li><span class="ion-ios-checkmark"></span>Insert Leaves</li>
    							<li><span class="ion-ios-checkmark"></span>Calculate Leaves</li>
    						</ul>
    					</div>
    				</div>
    			</div>
