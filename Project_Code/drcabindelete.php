...
<table border="1">
    <?php
    $id=$_POST['Delete'];
    $dislpaydata = "select * from doctor_cabin_cleaning where Cabin_Cleaninng_Id=$id";
...
<tr><td></td><td><button formaction="drcabindeletesave.php" name="save" value="<?php echo $row["Cabin_Cleaninng_Id"];?>"> Delete </button></td></tr>
</table>
        </center>
</form>
</table><br>
