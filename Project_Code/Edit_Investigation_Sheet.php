      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            ...
            <h1 class="mb-3 bread">Investigation Sheet</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            <h2 class="mb-4">Patient Investigation Sheet</h2>
        ...
        <div class="row d-flex justify-content-center">
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Sr No.</th>
                        <th>Investigation Sheet date</th>
                        <th>Investigation Sheet time</th>
                        <th>Edit / Print</th>
                    </tr>
                </thead>
                <?php 
                $srno = 0;
                $view_patient_ivs = "SELECT * FROM treatment_investigation_sheet WHERE "
                ...
                <tbody>
                    <tr>
                        <td><?php echo $srno;?></td>
                        <td><?php echo $row_patient_ivs["Investigation_Sheet_date"]?></td>
                        <td><?php echo $row_patient_ivs["Investigation_Sheet_time"]?></td>
                        <td>
                            <a href="patient_document_update/Investigation_Sheet.php?patient_id=<?php echo $patient_id; ?>&admin_name=<?php echo $login_name;?>&treatment_id=<?php echo $treatment_id;?>&Treatment_Investigation_Sheet_id=<?php echo $row_patient_ivs["Treatment_Investigation_Sheet_id"]?>"
