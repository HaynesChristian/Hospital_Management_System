        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Attendance Delete</span>
            </p>
            <h1 class="mb-3 bread">Attendance Delete</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="attendancedeletesave.php">
              <input type="hidden" value="<?php echo $login_name;?>" name="admin_name">    
              <table border="0" class="table table-striped" style="width:100%;">
                <?php
                $act=$_GET['Delete'];
				$displaydata = "select employee_master.Employee_Name , attendance.* from attendance,employee_master WHERE attendance.Emp_Id = employee_master.Employee_Id AND Attendance_calc_id='$act'";
                ...
                <tbody>
                    <tr>
                        <td>
							...
							<input type="hidden" value="<?php echo $employee_row["Attendance_calc_id"];?>" name="Attendance_calc_id">		 
                            </div>
                        </td>
                        <td>                        
                            <div class="form-group">
                            ...
                            <input type="text" name="mcode" class="form-control" 
                                     required="" readonly=""
                                     value="<?php echo $employee_row["Month_code"]?>">
