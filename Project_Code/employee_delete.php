        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Employee Delete</span>
            </p>
            <h1 class="mb-3 bread">Employee Delete</h1>
          </div>
        </div>
      </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <input type="text" name="designation" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Employee_Designation"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="tel" name="mobile" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Employee_contact"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="email" name="mail" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Employee_Email"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="birth" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Birth_Date"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="address" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Employee_Address"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="gender" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Gender"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="education" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Education"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="join" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Join_Date"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="bsalary" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Basic_Salary"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            <label for="uniform" class="text-black">Uiform Issued Date</label>
                            <input type="text" name="uniform" class="form-control" id="address" 
                                   readonly="" value="<?php echo $employee_row["Uniform_Issued_Date"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="increment" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Incremental_qtr_No"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="lincrement" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Last_Increment_Date"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <label for="address" class="text-black">IFSC Code</label>
                            <input type="text" name="address" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["IFSC_Code"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="bank" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Bank_Acc_No"]?>">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="department" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Department"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="grade" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Grade"]?>">
                            </td>
                            </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="da" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Dearness_Allowance"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="hra" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["House_Rent_Allowance"]?>">
                            </td>
                            </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="pfno" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["PF_No"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="pfper" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["PF_PCTG"]?>">
                            </td>
                            </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="familypf" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["FPS_PCTG"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="professional" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Professional_Tax"]?>">
                            </td>
                            </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="glic" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Group_LIC_Premium"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            ...
                            <input type="text" name="status" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["Status"]?>">
                            </td>
                            </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="pancard" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["PanCard"]?>">
                            </div>                                
                        </td>
                        <td>
                            <div class="form-group">
                            <label for="adharcard" class="text-black">AdharCard</label>
                            <input type="text" name="adharcard" class="form-control" 
                                   readonly="" value="<?php echo $employee_row["AdharCard"]?>">
                            </div>                                
                        </td>
                    </tr>
                    </tbody>
