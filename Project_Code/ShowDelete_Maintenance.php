...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Delete Maintenance</span></p>
            <h1 class="mb-3 bread">Delete Maintenance Details</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
          <form method="POST" action="delete_maintenance.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                $view_supplierdetails = "SELECT * FROM maintenance_of_item "
                        . "WHERE maintenance_of_item.Maintenance_Id = $MaintenanceId";
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_contactNo" class="text-black">Maintenance Date</label>
                            <input type="date" readonly=""  class="form-control"
                              id="maintenanceDate" name="maintenanceDate" value="<?php echo $dr_row["Maintenance_Date"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Status Of Item</label>
                            <input type="text" readonly=""  class="form-control"
                              id="statusOfItem" name="statusOfItem" value="<?php echo $dr_row["Status_Of_Item"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black"> Depreciation Rate</label>
                            <input type="text" readonly=""  class="form-control"
                              id="depreciationRate" name="depreciationRate" value="<?php echo $dr_row["Depreciation_Rate"];?>">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="submit" value="Delete Maintenance Details" class="btn btn-primary">
