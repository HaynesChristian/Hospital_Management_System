...
<table border="1">
    <?php
    $id=$_POST['Delete'];
    $dislpaydata = "select * from laboratory_cleaning where Laboratory_Cleaning_Id=$id";
...
<td><input type="text" name="count" value="<?php echo $row["Cleaning_Count"];?>"/></td>
</tr>
<tr>s
<td>Last_Cleaning_Date</td>
<td><input type="date" name="cdate" value="<?php echo $row["Last_Cleaning_Date"];?>"/></td>
</tr>
<tr><td></td><td><button formaction="laboratorydeletesave.php" name="save" value="<?php echo $row["Laboratory_Cleaning_Id"];?>"> Delete </button></td><</tr>
</table>
</form>
</table><br>
    <?php
