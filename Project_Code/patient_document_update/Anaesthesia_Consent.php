...
<html>
    ...
    <body class="container" style="font-family: Times New Roman; font-size: 16px;" 
        ...
        <br><br>
        <form action="Update_Anaesthesia_Consent.php" method="POST">
        ...
        <?php
            $view_patient_ts = "SELECT * FROM treatment_surgery , patient WHERE "
                    . "Treatment_id = $treatment_id AND Patient_id = $patient_id "
        ...
        <div class="justify-content-center" style="padding-top: 1%;">
            Hereby I/my relative<input type="text" value="<?php echo $row_patient_ts["Patient_Name"];?>" readonly="">
            (Patient Name), give my full
            consent as an act of my own free will to undergo
            <?php
            $anesthesia = explode(",",$row_patient_ts["Anaesthesia_Type"]);
			//print_r ($anesthesia);
            ?>			
            <input type="checkbox" name="anaesthesia_type[]" value="GA"
			<?php if(in_array("GA", $anesthesia)) {echo 'checked="checked"';}?>/>GA
            <input type="checkbox" name="anaesthesia_type[]" value="LA"
			<?php if(in_array("LA", $anesthesia)) {echo 'checked="checked"';}?>/>LA
            <input type="checkbox" name="anaesthesia_type[]" value="Spinal"
			<?php if(in_array("Spinal", $anesthesia)) {echo 'checked="checked"';}?>/>Spinal
            <input type="checkbox" name="anaesthesia_type[]" value="Epidural"
			<?php if(in_array("Epidural", $anesthesia)) {echo 'checked="checked"';}?>/>Epidural
            <input type="checkbox" name="anaesthesia_type[]" value="Regional"
            ...
            Dr.<input type="text" name="anaesthetist_name" id="anae_name1" onblur="anae_name()"
                      value="<?php echo $row_patient_ts["Anaesthetist_Name"];?>">
            ...
            <table>
                <tbody>
                    <tr>
                        <td><input type="text" value="<?php echo $row_patient_ts["Patient_Relative_name"];?>" readonly=""></td>
                        <td><input type="text" id="anae_name2" readonly="" value="<?php echo $row_patient_ts["Anaesthetist_Name"];?>"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="text" value="<?php echo $row_patient_ts["Patient_Relative_Relation"];?>" readonly=""><br>
                        </td>
                    </tr>
                    <tr>
