...
if($_POST)
{
    ...
    $Clinical_handover_id = $_POST["Clinical_handover_id"];
    $handover_date = $_POST["handover_date"];
    $verbal_order = trim($_POST["verbal_order"]);
    
    $qry_st = 0;
    
    $clinical_treatment = "UPDATE treatment_clinical_handover SET "
            . "Treatment_id = $treatment_id , Handover_date = '$handover_date' , Verbal_order = '$verbal_order' "
    ...
    $delete_patient_assessment = "DELETE FROM treatment_patient_assessment WHERE Treatment_id = $treatment_id";
    if(mysqli_query($connection, $delete_patient_assessment))
    {
    ...
    {
        echo "<script>alert('Clinical Handover Details Not Updated');"
