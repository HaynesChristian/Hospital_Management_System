            ...
            <div class="row d-flex">
                <div class="col-lg-6 d-flex ftco-animate">
                    <div class="dept d-md-flex">
                        <a href="laboratory_test.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/laboratory-test.jpeg );"></a>
                        <div class="text p-4">
                            <h3><a href="laboratory_test.php?admin_name=<?php echo $login_name;?>">Laboratory Test</a></h3>
                            <p>Insert New Lab Test.
                                View details and generate lab test Bill.</p>
                            <ul>
                                <li><span class="ion-ios-checkmark"></span>Insert Lab Test</li>
                                <li><span class="ion-ios-checkmark"></span>Generate Lab Test Bill</li>
    			...
    			<div class="col-lg-6 d-flex ftco-animate">
    				<div class="dept d-md-flex">
                                    <a href="lab_alltest_data.php?admin_name=<?php echo $login_name;?>" class="img" style="background-image: url(images/lab-test-details.jpg);"></a>
    					<div class="text p-4">
                                            <h3><a href="lab_alltest_data.php?admin_name=<?php echo $login_name;?>">Labotatory Test Details</a></h3>
    						<p>View All Patients lab test details.  </p>
    						<ul>
    							<li><span class="ion-ios-checkmark"></span>Display Test Data</li>
    					        </ul>
    					</div>
    				</div>
    			</div>
