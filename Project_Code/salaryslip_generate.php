...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <p>
                   ...
                   <h2 align="center"> Generate salaryslip </h2>
           
                   <center>
                       <a class="btn btn-primary" data-toggle="modalApp" data-target="#modalApp" style="margin-top: 2%" >
                           Generate Date
                       </a>
                   </center>
                   <br>
    ...
    $dislpaydata = "select * from payslip";
