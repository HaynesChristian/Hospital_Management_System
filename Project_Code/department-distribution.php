...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php?admin_name=<?php echo $login_name;?>">Home</a></span> <span class="mr-2"><a href="departments.php?admin_name=<?php echo $login_name;?>">Departments</a></span> <span>Distribution Of Item</span></p>
            <h1 class="mb-3 bread">Distribution Of Item</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalDistribute">
          ...
          <div class="col-md-8 ftco-animate">
              <table border="0" id="myTable" style="padding: 2%" class="table table-striped">
                  ...
                  <tr style="text-align: center">
                       ...
                       <th>Item Receiver</th>
                       <th>Item Receiver Type</th>
                       <th>Action</th>
                       
                  </tr>
                    <?php
                    $dislpaydata = "select * from distribution_of_item,item_master "
                            . "where item_master.Item_Code = distribution_of_item.Item_Code "
                    ...
                    <form method="POST" autocomplete="off">
                        ...
                        <td><?php echo $row["Distribution_Quantity"];?></td>
                        <td><?php echo $row["Item_Receiver"];?></td>
                        <td><?php echo $row["Item_Receiver_Type"];?></td>
                        <td>
                            <a href="ShowUpdate_Distribution.php?DistributionId=<?php echo $row["Distribution_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Update
                            </a>   <br><br>
                                  <a href="ShowDelete_Distribution.php?DistributionId=<?php echo $row["Distribution_Id"];?>&admin_name=<?php echo $login_name;?>"
                                 class="btn btn-primary">
                                Delete
                              </a>   
  ...
  <!-- Distribution Modal -->
    <div class="modal fade" id="modalDistribute" tabindex="-1" 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="distribute.php" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              <div class="form-group">
                <label for="Doctor_name" class="text-black"> Distribution Quantity</label>
                <input type="number" class="form-control" id="distributeQty" name="distributeQty" required="">
              </div>
              <div class="form-group">
                  <label for="Doctor_name" class="text-black">Item Receiver</label><br>
                  <input type="text" class="form-control" id="itemReceiver" name="itemReceiver" required="">
              </div>
              <div class="form-group">
                <label for="Doctor_name" class="text-black">Item Receiver Type</label>
                <input type="text" class="form-control" id="itemReceiverType" name="itemReceiverType" required="">
              </div>
