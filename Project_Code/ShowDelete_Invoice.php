        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs">
                ...
                <span>Delete Invoice</span></p>
            <h1 class="mb-3 bread">Delete Invoice Details</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
          <form method="POST" action="delete_invoice.php">
              <table border="1" class="table table-striped" style="width:75%;">
                ...
                $view_supplierdetails = "SELECT * FROM invoice "
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_address" class="text-black">Invoice Date</label>
                            <input type="date" class="form-control"
                              id="invoiceDate" name="invoiceDate" value="<?php echo $dr_row["Invoice_Date"];?>">
                    ...
                    <tr>
                        <td>
                            <label for="Doctor_contactNo" class="text-black">Purchase Id</label>
                            <select class="form-control" id="purchasaeId" name="purchaseId" required="">
                                    <?php
                                    ...
                                    ?>
                                     ...
                                     <option value="<?php echo $row["Purchase_Id"];?>"
                                              <?php if($row["Purchase_Id"] == $dr_row["Purchase_Id"]){echo "selected='selected'";}?>>
                    ...
                    <tr>
                        <td>
                            <input type="submit" value="Delete Invoice Details" class="btn btn-primary">
