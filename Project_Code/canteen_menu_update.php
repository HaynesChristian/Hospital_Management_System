        ...
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p>
                ...
                <span>Canteen Menu Update</span>
            </p>
            <h1 class="mb-3 bread">Canteen Menu Update</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <form method="POST" action="canteenmenuupdatesave.php">
                    ...
                    <tr>
                        <td>                        
                            ...
                            <input type="text" name="item" class="form-control" 
                                    value="<?php echo $employee_row["Food_Item_Name"]?>">
                            </div>                                
                        </td>
                    </tr>
                    <tr>
                        <td>                        
                            ...
                            <input type="number" name="charges" class="form-control" 
                                    value="<?php echo $employee_row["Food_Item_Charges"]?>">
                            </div>                                
                        </td>
                    </tr>
                    </tbody>
