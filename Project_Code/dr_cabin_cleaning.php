  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    ...
    <center>
        <a href="" data-toggle="modal" data-target="#modalAppointmen">
            <input type="submit" class="btn btn-primary" value="Cabin Cleaning" 
               style="margin-top: 2%">
        </a>
    </center>                    
  <br>
...
<center>
    <table class="table table-striped">
        <h4>Cabin Cleaning</h4>
    <tr>
        <th>Canteen Cleaning Id</th>
    ...
    <?php
    $dislpaydata = "select * from doctor_cabin_cleaning";
    ...
    <form method="POST" autocomplete="off">
        <td><?php echo $row["Cabin_Cleaninng_Id"];?></td>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form action="drcabin.php" autocomplete="off" method="POST">
                  <input type="hidden" value="<?php echo $login_name;?>" name="admin_name">      
                  <div class="col-md-6">
                  <div class="form-group">
                    <label for="month" class="text-black">Cleaning Month</label>
                    <input type="month" class="form-control" name="month"></div>    
                </div>
              ...
              <div class="col-md-6">      
              <div class="form-group">
                <input type="submit" value="Cleaning Details" class="btn btn-primary" href="dr_cabin_cleaning.php">
              </div>
                  </div>
            </form>
          </div>
